<?php get_header(); ?>
		...
		<div id="archivebox">
            	...
            	<h3><em>Archivo |</em> <?php echo single_cat_title(); ?></h3>        
            	
            	<div class="archivefeed"><?php $cat_obj = $wp_query->get_queried_object(); $cat_id = $cat_obj->cat_ID; echo '<a href="'; get_category_rss_link(true, $cat, ''); echo '">RSS feed para esta secci&oacuten</a>'; ?></div>
