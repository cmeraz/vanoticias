		...
		<?php if (have_posts()) : ?>
			...
			<?php while (have_posts()) : the_post(); ?>		
                ...
                <div class="author_info">
                    ...
                    <p><?php the_author_posts_link(); ?> - quien ha escrito <?php the_author_posts(); ?> entradas en <a href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a>.</p>
                    <p><?php the_author_description(); ?> <br style="clear:both;" /></p>
                    <p class="author_email"><a href="mailto:<?php the_author_email(); ?>">Contactar al Autor</a></p>
                </div>
